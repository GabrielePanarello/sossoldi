...
class _AccountSetupState extends ConsumerState<AccountSetup> {
  ...
  void _validateForm() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (!_isFormTouched && accountNameController.text.isNotEmpty) {
        setState(() {
          _isFormTouched = true;
        });
      }
  ...
  @override
  void initState() {
    accountNameController.addListener(_validateForm);
  ...
  @override
  void dispose() {
    accountNameController.removeListener(_validateForm);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: Validators.amountFormat,
